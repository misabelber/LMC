{
  ...
  for (int i=0; i<nmasses; i++){
    ...
    TString filename1 = "/home/queenmab/GitHub/LMC/results/limit"+particle+masstr+"_BestCase.dat";
    TString filename2 = "/home/queenmab/GitHub/LMC/results/limit"+particle+masstr+".dat";
