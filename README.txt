...
--Pipelines in C++/Root:
	    ...
	    To run the pipelines in C++/Root which are for likelihood fitting and upper 
	    limits calculation it's necessary to configure the right paths in the file config.sh. 
